...
const Billing = () => (
	<section id="product" className={layout.sectionReverse}>
		...
		<div className={layout.sectionInfo}>
			...
			<p className={`${styles.paragraph} max-width-[470px] mt-5`}> sit aernatur, neque rem sequi. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quam, harum animi! Incidunt maiores modi possimus?</p>
